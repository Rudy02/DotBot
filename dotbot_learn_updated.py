...
########################################################################################
# Author: Kerstin Voigt, Jan 2018; inspired by Nils Nilsson, Introduction to
# Artificial Intelligence: A New Synthesis
#
# Co-Authors: Rodolfo Diaz and Hector Medina
# Other colleagues who helped: Frank Victoria and Allen Sokoupatham
...
class DotBot:
    ...
    # Notice: given current dotbot, will return a TUPLE with
    ...
    # Notice: the left/right/up/down moves
    def move_up(self):
